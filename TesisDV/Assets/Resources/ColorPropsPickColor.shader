...
Shader "ColorPropsPickColor"
{
	Properties
	{
		...
		_Color_Base1("Color_Base", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			float4 temp_output_110_0 = ( Shadow105 * ase_lightColor * _LightIntensity );
			float4 LightColor112 = temp_output_110_0;
			c.rgb = ( ( LightColor112 * ( 1.0 - step( ase_lightAtten , 0.57 ) ) ) * _Color_Base1 ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
-1920;5;1920;1011;2318.252;2925.864;1.863079;True;True
...
Node;AmplifyShaderEditor.ColorNode;92;-2119.516,-3847.574;Inherit;False;Property;_Tint;Tint;9;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;97;-2325.443,-3044.5;Inherit;False;94;Normal_LightDir;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;96;-2341.443,-2836.5;Inherit;False;Property;_Levels;Levels;1;0;Create;True;0;0;False;0;71;71;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-2277.443,-2132.5;Inherit;False;Property;_LightIntensity;LightIntensity;10;0;Create;True;0;0;False;0;0;2.77;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;121;162.1027,-1736.356;Inherit;False;Property;_Color_Base1;Color_Base;8;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;123;485.9272,-1807.193;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;87;-44.32228,-916.7968;Inherit;False;Property;_Color_Base;Color_Base;7;0;Create;True;0;0;False;0;0,0,0,0;0.04231142,1,0.01370208,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;122;-1530.387,-1946.336;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=4C2FFD1E003432A7BC3E8402FAE87AA794237591