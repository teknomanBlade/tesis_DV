...
Shader "ToonShadowsInteriorRandomByCode"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_91_0 = min( _Min1 , _Max1 );
			float temp_output_88_0 = max( _Max1 , _Min1 );
			...
			float smoothstepResult96 = smoothstep( temp_output_91_0 , temp_output_88_0 , ( temp_output_87_0 - _FirstPosition1 ));
			float smoothstepResult94 = smoothstep( temp_output_91_0 , temp_output_88_0 , ( temp_output_87_0 - _SecondPosition1 ));
			float temp_output_99_0 = ( saturate( smoothstepResult96 ) + saturate( ( smoothstepResult94 - _SecondPositionIntensity1 ) ) );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			c.rgb = saturate( ( ( ( color60 * tex2DNode59.g ) + ( _Color_Title * tex2DNode59.b ) + ( _Color_Base * tex2DNode59.r ) ) * ( ( temp_output_99_0 + ( ( 1.0 - temp_output_99_0 ) * _ShadowIntensity1 ) ) * ase_lightColor * ase_lightAtten ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
364;370;1137;574;-143.5108;825.8922;1.28006;True;False
Node;AmplifyShaderEditor.CommentaryNode;78;-2209.389,-693.2631;Inherit;False;2894.373;778.0368;Main Light;27;105;104;103;102;101;100;99;98;97;96;95;94;93;92;91;90;89;88;87;86;85;84;83;82;81;80;79;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;87;-1476.509,-609.7253;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;85;-1748.649,-234.5616;Inherit;False;Property;_Max1;Max;1;0;Create;True;0;0;False;0;0;6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;84;-1158.416,-291.9538;Inherit;False;Property;_SecondPosition1;Second Position;3;0;Create;True;0;0;False;0;0;0.56;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1742.649,-318.5612;Inherit;False;Property;_Min1;Min;0;0;Create;True;0;0;False;0;0;0.57;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;90;-960.9636,-317.4745;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;88;-1411.649,-227.5616;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;-1259.626,-494.2953;Inherit;False;Property;_FirstPosition1;First Position;2;0;Create;True;0;0;False;0;0;0.72;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMinOpNode;91;-1410.649,-330.5612;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;93;-833.6528,-46.84336;Inherit;False;Property;_SecondPositionIntensity1;Second Position Intensity;5;0;Create;True;0;0;False;0;0;3.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;92;-1071.612,-558.4518;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;94;-822.6127,-255.687;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;96;-816.6157,-518.8068;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;101;58.69538,-61.92833;Inherit;False;Property;_ShadowIntensity1;Shadow Intensity;6;0;Create;True;0;0;False;0;0;1.88;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;77;250.1048,-1346.8;Inherit;False;Property;_Color_Title;Color_Title;8;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;67;238.8151,-1608.011;Inherit;False;Property;_Color_Base;Color_Base;7;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;59;-183.8613,-1091.95;Inherit;True;Property;_MainTexture;Main Texture;4;0;Create;True;0;0;False;0;-1;8abc7d31b91727c4c9c0a7b379f620f5;8abc7d31b91727c4c9c0a7b379f620f5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightAttenuation;105;543.6732,59.06527;Inherit;False;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=5992A00B0B3E988D8A30AD6F943FD9F4F7E45022