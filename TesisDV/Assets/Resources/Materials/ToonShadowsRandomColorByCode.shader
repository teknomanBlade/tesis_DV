...
Shader "ToonShadowsInteriorRandomByCode"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = saturate( ( ( ( color60 * tex2DNode59.g ) + ( _Color_Title * tex2DNode59.b ) + ( _Color_Base * tex2DNode59.r ) ) * ( _TintColor * ( ( smoothstepResult34 * ase_lightColor ) + ( _SpecularColor * smoothstepResult37 * ase_lightAtten ) + ( _RimColor * ase_lightAtten * smoothstepResult36 ) + _AmbientColor ) ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
1920;110;1906;880;1655.983;1917.005;2.313544;True;False
...
Node;AmplifyShaderEditor.SamplerNode;59;-183.8613,-1091.95;Inherit;True;Property;_MainTexture;Main Texture;6;0;Create;True;0;0;False;0;-1;8abc7d31b91727c4c9c0a7b379f620f5;8abc7d31b91727c4c9c0a7b379f620f5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;67;238.8151,-1608.011;Inherit;False;Property;_Color_Base;Color_Base;8;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;77;250.1048,-1346.8;Inherit;False;Property;_Color_Title;Color_Title;9;0;Create;True;0;0;False;0;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=44C9E1A8E7B4BE036CB0C2945585D9C51062EA30