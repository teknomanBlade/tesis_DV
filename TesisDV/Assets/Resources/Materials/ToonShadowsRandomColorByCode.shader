	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = saturate( ( ( ( color60 * tex2DNode59.g ) + ( _Color_Title * tex2DNode59.b ) + ( _Color_Base * tex2DNode59.r ) ) * ( _TintColor * ( ( smoothstepResult34 * _MainLightColor ) + ( _SpecularColor * smoothstepResult37 * ase_lightAtten ) + ( _RimColor * ase_lightAtten * smoothstepResult36 ) + _AmbientColor ) ) ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=18900
1927;84;1906;935;-647.6979;1102.817;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;77;250.1048,-1346.8;Inherit;False;Property;_Color_Title;Color_Title;9;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;40;176,-17;Inherit;False;Property;_AmbientColor;Ambient Color;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;59;-183.8613,-1091.95;Inherit;True;Property;_MainTexture;Main Texture;6;0;Create;True;0;0;0;False;0;False;-1;8abc7d31b91727c4c9c0a7b379f620f5;8abc7d31b91727c4c9c0a7b379f620f5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;67;238.8151,-1608.011;Inherit;False;Property;_Color_Base;Color_Base;8;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;43;320,-704;Inherit;False;Property;_TintColor;TintColor;0;0;Create;True;0;0;0;False;0;False;0.735849,0.735849,0.735849,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;79;2;50;0
ASEEND*/
//CHKSM=2022219FF49B4084EA2248956669D3E6E257D57E