...
Shader "EdShaders/SurfaceBubbles Toon"
{
	Properties
	{
		...
		[ASEEnd]_Shading("Shading", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _UpPushAmount;
			float _OutwardPushAmount;
			float _Specular;
			float _Shininess;
			float _noisescale;
			float _Shading;
			float _SelfIllunimated;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 worldToObjDir29 = mul( GetWorldToObjectMatrix(), float4( appendResult21.xyz, 0 ) ).xyz;
				float temp_output_50_0 = ( 1.0 - pop84 );
				float3 worldToObjDir28 = mul( GetWorldToObjectMatrix(), float4( ase_worldNormal, 0 ) ).xyz;
				float4 texCoord134 = v.texcoord;
				texCoord134.xy = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 vertexValue = ( ( worldToObjDir29 + ( ( _OutwardPushAmount * ( 1.0 - ( temp_output_50_0 * temp_output_50_0 ) ) ) * ( (UpFacing139*0.5 + 0.5) * temp_output_10_0 ) * worldToObjDir28 ) ) * ( 1.0 - step( temp_output_10_0 , 0.0 ) ) * texCoord134.z );
						 ...
						 ) : SV_Target
			{
				...
				float pop84 = ( 1.0 - IN.ase_color.a );
				float2 texCoord89 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float4 texCoord155 = IN.ase_texcoord8;
				texCoord155.xy = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord156 = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult157 = (float3(texCoord155.w , texCoord156));
				float3 break159 = appendResult157;
				float2 appendResult116 = (float2(break159.x , break159.z));
				float simplePerlin2D86 = snoise( ( texCoord89 + appendResult116 )*_noisescale );
				simplePerlin2D86 = simplePerlin2D86*0.5 + 0.5;
				float dotResult4 = dot( float3(0,-1,0) , WorldNormal );
				float UpFacing139 = dotResult4;
				float Shading143 = ( saturate( ( ( 1.0 - pop84 ) + ( simplePerlin2D86 * simplePerlin2D86 ) ) ) * saturate( -UpFacing139 ) );
				float3 temp_output_169_0 = ( (IN.ase_color).rgb * saturate( ( Shading143 + ( 1.0 - _Shading ) ) ) );
				float4 temp_output_42_0_g3 = float4( temp_output_169_0 , 0.0 );
				
				float4 texCoord202 = IN.ase_texcoord9;
				texCoord202.xy = IN.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				

				float3 BaseColor = max( ( ( float4( (temp_output_43_0_g3).rgb , 0.0 ) * (temp_output_43_0_g3).a * pow( max( dotResult19_g3 , 0.0 ) , ( _Shininess * 128.0 ) ) * temp_output_40_0_g3 ) + ( ( ( temp_output_40_0_g3 * max( dotResult14_g3 , 0.0 ) ) + float4( bakedGI34_g3 , 0.0 ) ) * float4( (temp_output_42_0_g3).rgb , 0.0 ) ) ) , float4( ( temp_output_169_0 * _SelfIllunimated ) , 0.0 ) ).rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float temp_output_50_0 = ( 1.0 - pop84 );
				float3 worldToObjDir28 = mul( GetWorldToObjectMatrix(), float4( ase_worldNormal, 0 ) ).xyz;
				float4 texCoord134 = v.ase_texcoord;
				texCoord134.xy = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
						 ...
						 ) : SV_TARGET
			{
				...
				float4 texCoord202 = IN.ase_texcoord2;
				texCoord202.xy = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_50_0 = ( 1.0 - pop84 );
				float3 worldToObjDir28 = mul( GetWorldToObjectMatrix(), float4( ase_worldNormal, 0 ) ).xyz;
				float4 texCoord134 = v.texcoord0;
				texCoord134.xy = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				MixRealtimeAndBakedGI(ase_mainLight, normalizeResult64_g3, bakedGI34_g3, half4(0,0,0,0));
				float pop84 = ( 1.0 - IN.ase_color.a );
				float2 texCoord89 = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float4 texCoord155 = IN.ase_texcoord6;
				texCoord155.xy = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord156 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 appendResult157 = (float3(texCoord155.w , texCoord156));
				float3 break159 = appendResult157;
				float2 appendResult116 = (float2(break159.x , break159.z));
				float simplePerlin2D86 = snoise( ( texCoord89 + appendResult116 )*_noisescale );
				...
				float4 texCoord202 = IN.ase_texcoord7;
				texCoord202.xy = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 texCoord202 = IN.ase_texcoord4;
				texCoord202.xy = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 texCoord202 = IN.ase_texcoord;
				texCoord202.xy = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				

				surfaceDescription.Alpha = ( 1.0 - texCoord202.z );
...
Node;AmplifyShaderEditor.RangedFloatNode;90;-262.3434,1526.93;Inherit;False;Property;_noisescale;noise scale;8;0;Create;True;0;0;0;False;0;False;1;11.19;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;3;-1953.304,394.7925;Inherit;False;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0,-1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-658.0982,-302.3145;Inherit;False;Property;_UpPushAmount;Up Push Amount;7;0;Create;True;0;0;0;False;0;False;5;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;197;1596.222,125.82;Inherit;False;Property;_Shading;Shading;12;0;Create;True;0;0;0;False;0;False;0;0.489;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;207;1431.879,1346.728;Inherit;False;Property;_MinimumClipLevel;Minimum Clip Level;13;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-446.6748,402.8947;Inherit;False;Property;_OutwardPushAmount;Outward Push Amount;6;0;Create;True;0;0;0;False;0;False;5;7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformDirectionNode;28;10.79404,588.1554;Inherit;False;World;Object;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;212;2136.712,234.9139;Inherit;False;Property;_SelfIllunimated;Self Illunimated;10;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformDirectionNode;29;596.9877,-453.1659;Inherit;False;World;Object;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;213;1874.186,-287.4597;Inherit;False;Property;_Specular;Specular;11;0;Create;True;0;0;0;False;0;False;0;2.33;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;564.4252,1324.565;Inherit;False;Property;_Bottomerosion;Bottom erosion;9;0;Create;True;0;0;0;False;0;False;0.3;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1;-1904.638,61.23404;Inherit;False;Property;_pop;pop;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;216;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;217;3130.018,212.599;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;EdShaders/SurfaceBubbles Toon;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638662694397425875;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;218;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;219;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;220;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;221;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;222;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;223;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;224;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;225;3130.018,212.599;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;217;6;215;0
WireConnection;217;8;94;0
ASEEND*/
//CHKSM=B77404010ADE8C4C12EAA3D9B206405D347416EC