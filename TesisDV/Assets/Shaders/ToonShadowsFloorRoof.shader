...
Shader "ToonShadowsFloorRoof"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 Albedo105 = ( _Tint2 * tex2D( _MainTexture, uv_MainTexture ) );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float4 LightColor115 = ( Albedo105 * ase_lightColor * _LightIntensity2 );
...
/*ASEBEGIN
Version=17800
524;398;1195;458;3343.486;4158.602;3.556906;True;False
Node;AmplifyShaderEditor.ColorNode;101;-1241.724,-3848.181;Inherit;False;Property;_Tint2;Tint;1;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;45;-1265.192,-3632.034;Inherit;True;Property;_MainTexture;Main Texture;0;0;Create;True;0;0;False;0;-1;None;0d7438c4e24e4774b9514c86cdf98f8f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-1399.651,-2133.107;Inherit;False;Property;_LightIntensity2;LightIntensity;2;0;Create;True;0;0;False;0;0;3.73;0;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3FA0B7D288F6330D71534BF7B8BC54BFF63F74E9