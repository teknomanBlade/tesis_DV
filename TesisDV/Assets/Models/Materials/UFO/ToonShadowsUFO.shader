...
Shader "ToonShadowsUFO"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float smoothstepResult34 = smoothstep( 0.001 , 0.01 , pow( ( ase_lightColor.a * dotResult18 ) , ( _Float0 * _Float0 ) ));
			...
			c.rgb = ( tex2D( _MainTexture, uv_MainTexture ) * tex2D( _Glossiness, uv_Glossiness ) * ( _MainColor * ( ( smoothstepResult36 * ase_lightColor ) + ( _SpecularColor * smoothstepResult34 * ase_lightAtten ) + ( _RimColor * ase_lightAtten * smoothstepResult35 ) + _AmbientColor ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
384;480;1307;545;3007.208;188.2004;2.025431;True;False
...
Node;AmplifyShaderEditor.WorldNormalVector;3;-2660.113,-634.4985;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;4;-2700.135,-121.2608;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;15;-2483.129,691.262;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;22;-2132.679,938.5767;Inherit;False;Property;_Rim;Rim;3;0;Create;True;0;0;False;0;0;0.774;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightColorNode;21;-1600.922,-592.7932;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;19;-1538.545,137.7318;Inherit;False;Property;_Float0;Float 0;4;0;Create;True;0;0;False;0;0;4.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1626.294,845.5819;Inherit;False;Property;_RimAmount;Rim Amount;7;0;Create;True;0;0;False;0;0;0.463;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;37;-1058.176,402.6392;Inherit;False;Property;_RimColor;Rim Color;2;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.6226415,0.6226415,0.6226415,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;52;699.8368,-621.8666;Inherit;True;Property;_Emission;Emission;9;0;Create;True;0;0;False;0;-1;86f98484553a7d147b640af14542471e;86f98484553a7d147b640af14542471e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;675.8247,-985.3293;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=62F0C203B58510EA7068BED74FB7D983616C18D2