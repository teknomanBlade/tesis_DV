...
Shader "UFOGraysPath"
{
	Properties
	{
		...
		_Divisor("Divisor", Float) = 0
		_Adding("Adding", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fbspeed78 = ( _Time.y - _SubtractValue ) * 0.0;
			...
			float temp_output_101_0 = abs( ( ( _Value - frac( ( ( _Time.y / _Divisor ) + _Adding ) ) ) / _Value ) );
			float4 lerpResult85 = lerp( tex2DNode74 , tex2DNode22 , temp_output_101_0);
			...
			float smoothstepResult68 = smoothstep( temp_output_66_0 , temp_output_64_0 , ( 1.0 - i.uv_texcoord.x ));
			...
			float lerpResult104 = lerp( tex2DNode74.a , tex2DNode22.a , temp_output_101_0);
...
/*ASEBEGIN
Version=17800
350;294;1137;535;2928.794;-1505.272;1.513938;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-2449.497,1456.515;Inherit;False;Property;_MinX;MinX;1;0;Create;True;0;0;False;0;0;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;-539.3734,462.1461;Inherit;False;Property;_Divisor;Divisor;11;0;Create;True;0;0;False;0;0;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-290.5251,528.329;Inherit;False;Property;_Adding;Adding;12;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;92;-322.293,361.5478;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;94;-49.61881,382.7264;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FractNode;96;204.5242,372.1371;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;355.8233,585.6725;Inherit;False;Property;_Value;Value;13;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;97;508.9662,411.8469;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;98;740.576,427.7308;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.AbsOpNode;101;976.2374,431.8616;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F2EA8DB831C2A9C2A3248CF8F7559AE41CBDC302