...
Shader "UFOGraysPath"
{
	Properties
	{
		...
		[ASEBegin]_TextureArrows("TextureArrows", 2D) = "white" {}
		_MinX("MinX", Float) = 0
		_MinY("MinY", Float) = 0
		...
		[ASEEnd]_TimeScale("TimeScale", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord27 = IN.ase_texcoord8.xy * _TilingTex1 + float2( 0,-5 );
				float mulTime83 = _TimeParameters.x * _TimeScale;
				...
				// Flipbook UV
				half2 fbuv73 = texCoord27 * fbtiling73 + fboffset73;
				// *** END Flipbook UV Animation vars ***
				float4 tex2DNode74 = tex2D( _TextureSample0, fbuv73 );
				float2 texCoord77 = IN.ase_texcoord8.xy * _TilingTex2 + float2( 0,-5 );
				...
				half2 fbuv78 = texCoord77 * fbtiling78 + fboffset78;
				...
				float smoothstepResult55 = smoothstep( temp_output_51_0 , temp_output_52_0 , ( 1.0 - texCoord50.x ));
				float smoothstepResult54 = smoothstep( temp_output_51_0 , temp_output_52_0 , texCoord50.x);
				float temp_output_66_0 = min( _MinY , _MaxY );
				float temp_output_64_0 = max( _MinY , _MaxY );
				float2 texCoord61 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult68 = smoothstep( temp_output_66_0 , temp_output_64_0 , ( 1.0 - texCoord61.y ));
				float smoothstepResult67 = smoothstep( temp_output_66_0 , temp_output_64_0 , texCoord61.y);
				...
				float3 Emission = temp_output_46_0.rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float smoothstepResult67 = smoothstep( temp_output_66_0 , temp_output_64_0 , texCoord61.y);
				float Smoothstep88 = ( ( saturate( smoothstepResult55 ) * saturate( smoothstepResult54 ) ) * ( saturate( smoothstepResult68 ) * saturate( smoothstepResult67 ) ) );
				float2 texCoord27 = IN.ase_texcoord2.xy * _TilingTex1 + float2( 0,-5 );
				float mulTime83 = _TimeParameters.x * _TimeScale;
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles73 = _Columns * _Rows;
				...
				// *** END Flipbook UV Animation vars ***
				float4 tex2DNode74 = tex2D( _TextureSample0, fbuv73 );
				float2 texCoord77 = IN.ase_texcoord2.xy * _TilingTex2 + float2( 0,-5 );
				float fbtotaltiles78 = _Columns * _Rows;
				float fbcolsoffset78 = 1.0f / _Columns;
				float fbrowsoffset78 = 1.0f / _Rows;
				float fbspeed78 = ( mulTime83 - _SubtractValue ) * 0.0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord27 = IN.ase_texcoord4.xy * _TilingTex1 + float2( 0,-5 );
				float mulTime83 = _TimeParameters.x * _TimeScale;
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles73 = _Columns * _Rows;
				...
				// *** END Flipbook UV Animation vars ***
				float4 tex2DNode74 = tex2D( _TextureSample0, fbuv73 );
				float2 texCoord77 = IN.ase_texcoord4.xy * _TilingTex2 + float2( 0,-5 );
				float fbtotaltiles78 = _Columns * _Rows;
				float fbcolsoffset78 = 1.0f / _Columns;
				float fbrowsoffset78 = 1.0f / _Rows;
				float fbspeed78 = ( mulTime83 - _SubtractValue ) * 0.0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float smoothstepResult67 = smoothstep( temp_output_66_0 , temp_output_64_0 , texCoord61.y);
				float Smoothstep88 = ( ( saturate( smoothstepResult55 ) * saturate( smoothstepResult54 ) ) * ( saturate( smoothstepResult68 ) * saturate( smoothstepResult67 ) ) );
				float2 texCoord27 = IN.ase_texcoord.xy * _TilingTex1 + float2( 0,-5 );
				float mulTime83 = _TimeParameters.x * _TimeScale;
				// *** BEGIN Flipbook UV Animation vars ***
				// Total tiles of Flipbook Texture
				float fbtotaltiles73 = _Columns * _Rows;
				...
				// *** END Flipbook UV Animation vars ***
				float4 tex2DNode74 = tex2D( _TextureSample0, fbuv73 );
				float2 texCoord77 = IN.ase_texcoord.xy * _TilingTex2 + float2( 0,-5 );
				float fbtotaltiles78 = _Columns * _Rows;
				float fbcolsoffset78 = 1.0f / _Columns;
				float fbrowsoffset78 = 1.0f / _Rows;
				float fbspeed78 = ( mulTime83 - _SubtractValue ) * 0.0;
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-2435.249,2094.396;Inherit;False;Property;_MaxY;MaxY;6;0;Create;True;0;0;0;False;0;False;0;0.36;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-892.5587,29.62512;Inherit;False;Property;_TimeScale;TimeScale;12;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-2433.249,2023.396;Inherit;False;Property;_MinY;MinY;2;0;Create;True;0;0;0;False;0;False;0;0.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-2451.497,1526.515;Inherit;False;Property;_MaxX;MaxX;5;0;Create;True;0;0;0;False;0;False;0;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-2449.497,1456.515;Inherit;False;Property;_MinX;MinX;1;0;Create;True;0;0;0;False;0;False;0;0.23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;100;191.9088,621.5818;Inherit;False;Property;_Value;Value;11;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;76;-368.5877,-108.5056;Inherit;False;Property;_TilingTex2;TilingTex2;4;0;Create;True;0;0;0;False;0;False;0.25,0.65;100,8;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;47;-311.8198,-413.9824;Inherit;False;Property;_TilingTex1;TilingTex1;3;0;Create;True;0;0;0;False;0;False;0.25,0.65;100,8;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;87;-377.6075,132.0932;Inherit;False;Property;_SubtractValue;SubtractValue;10;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-406.0748,-299.3912;Inherit;False;Property;_Columns;Columns;9;0;Create;True;0;0;0;False;0;False;0;17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;-396.1923,-218.6852;Inherit;False;Property;_Rows;Rows;8;0;Create;True;0;0;0;False;0;False;0;4.51;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;108;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;109;1731.892,-258.2746;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;UFOGraysPath;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638662669157684840;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;110;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;111;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;112;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;113;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;114;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;115;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;116;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;117;1731.892,-258.2746;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;109;2;46;0
WireConnection;109;6;60;0
ASEEND*/
//CHKSM=745FAE592A08E8F16A6E92BCDBB06BB12BDD4811