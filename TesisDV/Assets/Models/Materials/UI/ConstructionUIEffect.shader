...
Shader "ConstructionUIEffect"
{
	Properties
	{
		...
		[ASEEnd]_ChangeIntervalScale("ChangeIntervalScale", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _ColorTintTernary;
			float4 _ColorTintCuaternary;
			float4 _ColorPrimary;
			float4 _ColorTintSecondary;
			float _Tiling;
			float _Offset;
			float _ChangeIntervalScale;
			float _Float1;
			float _TimeScaleSecondary;
			float _FrecuencySecondary;
			float _PosterizePower;
			float _TimeScale;
			float _Frequency;
			float _OpacitySecondary;
			float _Opacity;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord114 = v.texcoord.xy * temp_cast_0 + temp_cast_1;
				float mulTime108 = _TimeParameters.x * _ChangeIntervalScale;
				float3 temp_cast_2 = (( texCoord114.y * sin( mulTime108 ) )).xxx;
				
				float3 vertexPos117 = v.vertex.xyz;
				float4 ase_clipPos117 = TransformObjectToHClip((vertexPos117).xyz);
				float4 screenPos117 = ComputeScreenPos(ase_clipPos117);
				o.ase_texcoord8 = screenPos117;
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_174_0 = distance( WorldViewDirection.y , WorldPosition.y );
				float mulTime183 = _TimeParameters.x * _TimeScaleSecondary;
				...
				float4 screenPos117 = IN.ase_texcoord8;
				float4 ase_screenPosNorm117 = screenPos117 / screenPos117.w;
				ase_screenPosNorm117.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm117.z : ase_screenPosNorm117.z * 0.5 + 0.5;
				float temp_output_11_0 = distance( WorldViewDirection.y , WorldPosition.y );
				float screenDepth117 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm117.xy ),_ZBufferParams);
				float distanceDepth117 = saturate( abs( ( screenDepth117 - LinearEyeDepth( ase_screenPosNorm117.z,_ZBufferParams ) ) / ( temp_output_11_0 ) ) );
				float DepthFade119 = distanceDepth117;
				float mulTime3 = _TimeParameters.x * _TimeScale;
				...
				float mulTime192 = _TimeParameters.x * 2.47;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 temp_cast_0 = (_Tiling).xx;
				float2 temp_cast_1 = (_Offset).xx;
				float2 texCoord114 = v.ase_texcoord.xy * temp_cast_0 + temp_cast_1;
				float mulTime108 = _TimeParameters.x * _ChangeIntervalScale;
				float3 temp_cast_2 = (( texCoord114.y * sin( mulTime108 ) )).xxx;
						 ...
						 ) : SV_TARGET
			{
				...
				float temp_output_174_0 = distance( ase_worldViewDir.y , WorldPosition.y );
				float mulTime183 = _TimeParameters.x * _TimeScaleSecondary;
				float temp_output_177_0 = sin( ( ( temp_output_174_0 + mulTime183 ) * _FrecuencySecondary ) );
				float4 temp_output_165_0 = ( _ColorTintCuaternary * ( 1.0 - temp_output_177_0 ) );
				float4 temp_cast_0 = (_OpacitySecondary).xxxx;
				float temp_output_11_0 = distance( ase_worldViewDir.y , WorldPosition.y );
				float mulTime3 = _TimeParameters.x * _TimeScale;
				float temp_output_2_0 = sin( ( ( temp_output_11_0 + mulTime3 ) * _Frequency ) );
				float4 temp_output_76_0 = ( _ColorTintSecondary * ( 1.0 - temp_output_2_0 ) );
				...
				float mulTime192 = _TimeParameters.x * 2.47;
				float temp_output_193_0 = sin( mulTime192 );
				float4 lerpResult194 = lerp( step( temp_output_165_0 , temp_cast_0 ) , step( temp_output_76_0 , temp_cast_1 ) , temp_output_193_0);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_0 = (_Tiling).xx;
				float2 temp_cast_1 = (_Offset).xx;
				float2 texCoord114 = v.texcoord0.xy * temp_cast_0 + temp_cast_1;
				float mulTime108 = _TimeParameters.x * _ChangeIntervalScale;
				float3 temp_cast_2 = (( texCoord114.y * sin( mulTime108 ) )).xxx;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float div169=256.0/float((int)_Float1);
				float4 posterize169 = ( floor( ( ( _ColorTintTernary * temp_output_177_0 ) + temp_output_165_0 ) * div169 ) / div169 );
				float4 screenPos117 = IN.ase_texcoord4;
				float4 ase_screenPosNorm117 = screenPos117 / screenPos117.w;
				ase_screenPosNorm117.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm117.z : ase_screenPosNorm117.z * 0.5 + 0.5;
				float temp_output_11_0 = distance( ase_worldViewDir.y , WorldPosition.y );
				float screenDepth117 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm117.xy ),_ZBufferParams);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = lerpResult194.r;
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-1586.753,-1508.76;Inherit;False;Property;_TimeScaleSecondary;TimeScaleSecondary;6;0;Create;True;0;0;0;False;0;False;0;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1376,464;Inherit;False;Property;_TimeScale;TimeScale;5;0;Create;True;0;0;0;False;0;False;0;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;182;-1138.753,-1594.76;Inherit;False;Property;_FrecuencySecondary;FrecuencySecondary;1;0;Create;True;0;0;0;False;0;False;0;25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-976,368;Inherit;False;Property;_Frequency;Frequency;0;0;Create;True;0;0;0;False;0;False;0;25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;179;-418.7531,-1866.76;Inherit;False;Property;_ColorTintCuaternary;ColorTintCuaternary;12;0;Create;True;0;0;0;False;0;False;0.5565186,1,0.4575472,0;0.0627451,0.2431373,0.8235295,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;178;-1130.727,-2242.765;Inherit;False;Property;_ColorTintTernary;ColorTintTernary;4;0;Create;True;0;0;0;False;0;False;0.06627893,1,0,0;0.7215686,0.07450981,0.7725491,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;181;-386.7531,-1626.76;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1;-1008,-272;Inherit;False;Property;_ColorPrimary;ColorPrimary;3;0;Create;True;0;0;0;False;0;False;0.06627893,1,0,0;0.7607844,0.7921569,0.06666667,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;75;-256,96;Inherit;False;Property;_ColorTintSecondary;ColorTintSecondary;11;0;Create;True;0;0;0;False;0;False;0.5565186,1,0.4575472,0;0.1618257,0.9528302,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;48;395.202,-118.9327;Inherit;False;Property;_PosterizePower;PosterizePower;9;0;Create;True;0;0;0;False;0;False;0;86.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;166;301.2469,-2058.76;Inherit;False;Property;_Float1;Float 1;10;0;Create;True;0;0;0;False;0;False;0;86.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;195;662.8574,971.0785;Inherit;False;Property;_ChangeIntervalScale;ChangeIntervalScale;15;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;1095.599,735.702;Inherit;False;Property;_Offset;Offset;14;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;189;78.75566,-1287.521;Inherit;False;Property;_OpacitySecondary;OpacitySecondary;8;0;Create;True;0;0;0;False;0;False;0;0.274;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;241.5088,675.2394;Inherit;False;Property;_Opacity;Opacity;7;0;Create;True;0;0;0;False;0;False;0;0.274;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;1084.23,615.9277;Inherit;False;Property;_Tiling;Tiling;13;0;Create;True;0;0;0;False;0;False;0;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;196;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;197;2763.02,-1251.942;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;11;ConstructionUIEffect;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;1;638663256264943377;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;198;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;199;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;200;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;201;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;202;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;203;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;204;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;205;2763.02,-1251.942;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;197;6;194;0
WireConnection;197;8;110;0
ASEEND*/
//CHKSM=05211F3BF01E563F5369EA3CC91AECB6CA72925C