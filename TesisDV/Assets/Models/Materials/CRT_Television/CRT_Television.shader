...
Shader "CRT_Television"
{
	...
	SubShader
	{
		...
		float voronoi52( float2 v, float time, inout float2 id, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float mulTime53 = _Time.y * 20.0;
			float time52 = 0.0;
			float2 coords52 = i.uv_texcoord * mulTime53;
			float2 id52 = 0;
			float voroi52 = voronoi52( coords52, time52,id52, 0 );
			o.Emission = ( tex2D( _TextureSample0, uv_TextureSample0 ) * voroi52 ).rgb;
		}
...
/*ASEBEGIN
Version=17800
194;448;1307;544;1880.828;1577.492;1.760047;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;51;-1553.829,-1624.263;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;53;-1526.171,-1414.731;Inherit;False;1;0;FLOAT;20;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.VoronoiNode;52;-1191.807,-1515.032;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;50;False;3;FLOAT;0;False;2;FLOAT;0;FLOAT;1
Node;AmplifyShaderEditor.SamplerNode;50;-1182.815,-1761.004;Inherit;True;Property;_TextureSample0;Texture Sample 0;8;0;Create;True;0;0;False;0;-1;None;8189b357ec7880a48b71b835c3782c5d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B600C91E1E487F5402CC237F9ED9B8A843DBBDBD