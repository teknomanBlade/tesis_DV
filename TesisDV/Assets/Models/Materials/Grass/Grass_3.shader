...
Shader "Grass_3"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( tex2D( _MainTexture, uv_MainTexture ) * ( _MainColor * ( ( smoothstepResult44 * ase_lightColor ) + ( _SpecularColor * smoothstepResult42 ) + ( _RimColor * float4( 0,0,0,0 ) * smoothstepResult43 ) + _AmbientColor ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
488;207;1307;550;3053.424;1676.485;4.638554;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-3643.902,-15.57309;Inherit;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-4238.034,785.2723;Inherit;False;Property;_Rim;Rim;3;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-3731.651,692.2764;Inherit;False;Property;_RimAmount;Rim Amount;7;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;-3081.926,-388.5763;Inherit;False;Property;_SpecularColor;Specular Color;5;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;52;-2213.702,-1196.11;Inherit;True;Property;_MainTexture;Main Texture;6;0;Create;True;0;0;False;0;-1;fba7886fe65ee4842a4036db6755936f;02efa2c86bd7a99418a4148f7183bca9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=27816AAAD9205709A0930ADA2E38EB8B8EDC7DC4