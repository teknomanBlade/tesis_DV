...
Shader "Grass_3"
{
	Properties
	{
		_TextureGrass3_Albedo("TextureGrass3_Albedo", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _TextureGrass3_Albedo;
		uniform float4 _TextureGrass3_Albedo_ST;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TextureGrass3_Albedo = i.uv_texcoord * _TextureGrass3_Albedo_ST.xy + _TextureGrass3_Albedo_ST.zw;
			float4 tex2DNode1 = tex2D( _TextureGrass3_Albedo, uv_TextureGrass3_Albedo );
...
/*ASEBEGIN
Version=17800
468;230;1307;573;825.318;514.0081;1.259697;True;False
Node;AmplifyShaderEditor.SamplerNode;1;-562.8318,-289.3191;Inherit;True;Property;_TextureGrass3_Albedo;TextureGrass3_Albedo;0;0;Create;True;0;0;False;0;-1;02efa2c86bd7a99418a4148f7183bca9;02efa2c86bd7a99418a4148f7183bca9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EC9B52150F6B1BE956ECE25B4A92493B6988AD07