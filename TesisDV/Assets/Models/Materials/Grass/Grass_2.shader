...
Shader "Grass_2"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( tex2D( _MainTexture, uv_MainTexture ) * ( _MainColor * ( ( smoothstepResult44 * ase_lightColor ) + ( _SpecularColor * smoothstepResult47 * ase_lightAtten ) + ( _RimColor * ase_lightAtten * smoothstepResult46 ) + _AmbientColor ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
488;207;1307;550;7707.032;1314.853;5.334343;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-4597.063,420.2846;Inherit;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-5191.195,1221.13;Inherit;False;Property;_Rim;Rim;3;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-4684.812,1128.134;Inherit;False;Property;_RimAmount;Rim Amount;7;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;45;-4116.693,685.1917;Inherit;False;Property;_RimColor;Rim Color;2;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;43;-4035.087,47.28137;Inherit;False;Property;_SpecularColor;Specular Color;5;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;54;-3166.863,-760.2525;Inherit;True;Property;_MainTexture;Main Texture;6;0;Create;True;0;0;False;0;-1;fba7886fe65ee4842a4036db6755936f;d7daa549577361e45847a77d9d2e0999;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=14DDA32FC76615EFE2C1CD8C5664071683CA3B51