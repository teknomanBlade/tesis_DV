...
Shader "SDR_GrayDog"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			c.rgb = saturate( ( tex2D( _MainGrayDogTex, uv_MainGrayDogTex ) * ( ( temp_output_44_0 + ( ( 1.0 - temp_output_44_0 ) * _ShadowIntensity ) ) * ase_lightColor * ( 1.0 - step( ase_lightAtten , 0.0 ) ) ) ) ).rgb;
			c.a = 1;
...
/*ASEBEGIN
Version=17800
353;470;1195;420;848.6233;-1642.482;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1984.468,1576.875;Inherit;False;Property;_SecondPosition;Second Position;2;0;Create;True;0;0;False;0;0;0.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1871.152,1169.203;Inherit;False;Property;_FirstPosition;First Position;1;0;Create;True;0;0;False;0;0;0.49;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-1374.693,1631.978;Inherit;False;Property;_SecondPositionIntensity;Second Position Intensity;5;0;Create;True;0;0;False;0;0;0.26;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-482.3457,1616.893;Inherit;False;Property;_ShadowIntensity;Shadow Intensity;6;0;Create;True;0;0;False;0;0;0.41;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;64;154.5122,764.5777;Inherit;True;Property;_MainGrayDogTex;MainGrayDogTex;8;0;Create;True;0;0;False;0;-1;b3280d41a7733a14bb7282dcacf6affa;b3280d41a7733a14bb7282dcacf6affa;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6AC7B3F287CD0E3BC2CF712225FF2DB1426ABD10