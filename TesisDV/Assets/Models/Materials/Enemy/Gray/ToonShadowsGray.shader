...
Shader "ToonShadowsGray"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			c.rgb = saturate( ( ( ( ( tex2D( _MainTexture, uv_MainTexture ) * posterize169 ) * lerpResult161 ) + EyesEffect151 ) * ( ( temp_output_113_0 + ( ( 1.0 - temp_output_113_0 ) * _ShadowIntensity ) ) * ase_lightColor * ( 1.0 - step( ase_lightAtten , 0.0 ) ) ) ) ).rgb;
			c.a = 1;
...
/*ASEBEGIN
Version=17800
163;203;1195;556;301.5958;2963.56;2.460357;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;158;-506.4803,-1128.42;Inherit;False;Property;_LerpAmount;LerpAmount;19;0;Create;True;0;0;False;0;0;0.3457976;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;160;343.3051,-1210.846;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=FA397FC2549BFB8E77314741CA886CC1F711C89D