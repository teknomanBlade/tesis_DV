	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = saturate( ( tex2DNode49 * ( ( temp_output_73_0 + ( ( 1.0 - temp_output_73_0 ) * _ShadowIntensity1 ) ) * _MainLightColor * ( 1.0 - step( ase_lightAtten , 0.0 ) ) ) ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-2035.364,-119.2145;Inherit;False;Property;_SecondPosition1;Second Position;1;0;Create;True;0;0;0;False;0;False;0;0.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;83;-1840.397,-136.1418;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-1873.614,-320.6795;Inherit;False;Property;_FirstPosition1;First Position;0;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-1626.154,136.3087;Inherit;False;Property;_SecondPositionIntensity1;Second Position Intensity;2;0;Create;True;0;0;0;False;0;False;0;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-643.0243,121.2237;Inherit;False;Property;_ShadowIntensity1;Shadow Intensity;4;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3646B1F37D3E8CE3AC4AE3ED264C18C8FEB9B12C