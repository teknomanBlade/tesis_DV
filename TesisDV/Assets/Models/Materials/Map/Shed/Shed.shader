...
Shader "Shed"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			c.rgb = saturate( ( tex2D( _TextureSample0, uv_TextureSample0 ) * ( ( temp_output_72_0 + ( ( 1.0 - temp_output_72_0 ) * _ShadowIntensity ) ) * ase_lightColor * ase_lightAtten ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
270;448;1137;604;5520.6;44.88681;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-6553.383,8.156273;Inherit;False;Property;_SecondPosition;Second Position;3;0;Create;True;0;0;False;0;0;3.92;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-6654.593,-194.1853;Inherit;False;Property;_FirstPosition;First Position;2;0;Create;True;0;0;False;0;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-6228.62,253.2668;Inherit;False;Property;_SecondPositionIntensity;Second Position Intensity;4;0;Create;True;0;0;False;0;0;4.32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-5336.272,238.1818;Inherit;False;Property;_ShadowIntensity;Shadow Intensity;5;0;Create;True;0;0;False;0;0;1.76;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;81;-4844.6,356.1132;Inherit;False;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E6709BAF61DB1FF1693A375F1EBC47CC19ED9E5C