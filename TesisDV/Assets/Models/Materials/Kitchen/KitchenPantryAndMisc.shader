...
Shader "KitchenPantryAndMisc"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 Albedo100 = ( _Tint * tex2D( _KitchenPantryAndMisc, uv_KitchenPantryAndMisc ) );
			...
			float dotResult125 = dot( temp_cast_0 , ase_worldlightDir );
			float lerpResult128 = lerp( dotResult126 , dotResult125 , _LerpLightDir);
			float Normal_LightDir92 = lerpResult128;
			float4 temp_cast_2 = (Normal_LightDir92).xxxx;
			float div102=256.0/float((int)(Normal_LightDir92*_Levels + _Levels));
			float4 posterize102 = ( floor( temp_cast_2 * div102 ) / div102 );
			...
			#endif //aselc
			float4 LightColor112 = ( Shadow104 * ase_lightColor * _LightIntensity );
...
/*ASEBEGIN
Version=17800
315;426;1307;593;4302.5;4189.833;3.46228;True;False
Node;AmplifyShaderEditor.CommentaryNode;88;-3673.458,-3815.809;Inherit;False;1086.271;885.3248;Normal LightDir;9;92;127;125;123;124;128;121;122;126;;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldNormalVector;122;-3584.114,-3701.781;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;121;-3600.114,-3541.781;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;123;-3556.412,-3184.514;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;126;-3360.112,-3653.781;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;125;-3294.15,-3391.919;Inherit;True;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;127;-3302.392,-3114.897;Inherit;False;Property;_LerpLightDir;LerpLightDir;8;0;Create;True;0;0;False;0;0;0.629;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;128;-2994.331,-3493.358;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;-0.2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;94;-2076.492,-3893.504;Inherit;False;Property;_Tint;Tint;6;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;92;-2799.222,-3367.591;Inherit;False;Normal_LightDir;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-2298.419,-2882.432;Inherit;False;Property;_Levels;Levels;3;0;Create;True;0;0;False;0;71;24.5;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-2234.419,-2178.432;Inherit;False;Property;_LightIntensity;LightIntensity;7;0;Create;True;0;0;False;0;0;2.57;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;124;-3543.592,-3360.415;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=EDAD2931FC2863E56FAE440C4D62185D811186CB