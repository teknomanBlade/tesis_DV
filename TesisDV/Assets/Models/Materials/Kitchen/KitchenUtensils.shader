...
Shader "PantryAndElements"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aseld
			float dotResult108 = dot( ase_normWorldNormal , ase_worldlightDir );
			float Normal_LightDir112 = dotResult108;
			float4 temp_cast_4 = (Normal_LightDir112).xxxx;
			float div119=256.0/float((int)(Normal_LightDir112*_Levels + _Levels));
			float4 posterize119 = ( floor( temp_cast_4 * div119 ) / div119 );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float dotResult108 = dot( ase_normWorldNormal , ase_worldlightDir );
			float Normal_LightDir112 = dotResult108;
			float4 temp_cast_1 = (Normal_LightDir112).xxxx;
			float div119=256.0/float((int)(Normal_LightDir112*_Levels + _Levels));
			float4 posterize119 = ( floor( temp_cast_1 * div119 ) / div119 );
			float4 Shadow121 = ( Albedo117 * posterize119 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
...
/*ASEBEGIN
Version=17800
514;594;1195;464;7073.529;6216.277;6.724943;True;False
Node;AmplifyShaderEditor.CommentaryNode;101;-4113.134,-2538.71;Inherit;False;787.1289;475.5013;Normal LightDir;4;112;108;104;103;;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldNormalVector;103;-4052.404,-2397.223;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;104;-4078.808,-2242.099;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DotProductOpNode;108;-3837.639,-2359.604;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;111;-2357.541,-4397.66;Inherit;False;Property;_Tint;Tint;4;0;Create;True;0;0;False;0;0,0,0,0;0.7830189,0.7830189,0.7830189,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;134;-3555.987,-3640.836;Inherit;True;Property;_TrimSheetPropsTex;TrimSheetPropsTex;10;0;Create;True;0;0;False;0;-1;None;881ec4261bc362e479cc15e5bdf8f5c2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;112;-3518.913,-2372.25;Inherit;False;Normal_LightDir;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-2990.336,-2449.576;Inherit;False;Property;_Levels;Levels;0;0;Create;True;0;0;False;0;71;23.9;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;122;-2770.384,-1892.769;Inherit;False;Property;_LightIntensity;LightIntensity;6;0;Create;True;0;0;False;0;0;4.73;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2257.464,-277.6025;Inherit;False;Property;_SecondPosition;Second Position;13;0;Create;True;0;0;False;0;0;0.26;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;92;104.2773,-1861.722;Inherit;False;Property;_EmissionLightBarn;EmissionLightBarn;17;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-3200.966,3260.968;Inherit;False;Property;_RimAmount;Rim Amount;12;0;Create;True;0;0;False;0;0;0.102;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-1549.145,-411.3083;Inherit;False;Property;_SecondPositionIntensity;Second Position Intensity;14;0;Create;True;0;0;False;0;0;0.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;39;-2551.241,2180.115;Inherit;False;Property;_SpecularColor;Specular Color;8;1;[HDR];Create;True;0;0;False;0;0,0,0,0;3.670588,3.670588,3.670588,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-605.4064,-109.9349;Inherit;False;Property;_ShadowIntensity;Shadow Intensity;15;0;Create;True;0;0;False;0;0;0.52;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;47;-353.5523,-1024.216;Inherit;True;Property;_MainTexture;Main Texture;11;0;Create;True;0;0;False;0;-1;None;881ec4261bc362e479cc15e5bdf8f5c2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-3113.218,2553.118;Inherit;False;Property;_Intensity;Intensity;7;0;Create;True;0;0;False;0;0;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;88;-3580.439,-4350.426;Inherit;True;Property;_OpacityMap_TrimSheetProps;OpacityMap_TrimSheetProps;16;0;Create;True;0;0;False;0;-1;2a2ea88b54a5fd348ab6b864b3e826b7;2a2ea88b54a5fd348ab6b864b3e826b7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-3707.351,3353.962;Inherit;False;Property;_Rim;Rim;5;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-1923.728,-542.3017;Inherit;False;Property;_FirstPosition;First Position;9;0;Create;True;0;0;False;0;0;0.17;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;139.4107,-1475.037;Inherit;False;Property;_EmissionLightLiving;EmissionLightLiving;18;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;100;-3571.699,-4029.757;Inherit;True;Property;_TrimSheetProps_LivingLightEmission;TrimSheetProps_LivingLightEmission;19;0;Create;True;0;0;False;0;-1;b85bbfc6ffeeab549a8949fddb6f3885;b85bbfc6ffeeab549a8949fddb6f3885;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;28;-3396.48,3258.962;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1856.113,-841.8466;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;PantryAndElements;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=5B25277C9FBFED9AC0CB5B9AA95CF96A85FA0B93