...
Shader "KitchenElements"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( tex2D( _MainTexture1, uv_MainTexture1 ) * tex2D( _Glossiness1, uv_Glossiness1 ) * ( _MainColor1 * ( ( smoothstepResult33 * ase_lightColor ) + ( _SpecularColor1 * smoothstepResult37 * ase_lightAtten ) + ( _RimColor1 * ase_lightAtten * smoothstepResult36 ) + _AmbientColor1 ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
390;232;1307;547;6681.894;1344.881;7.033828;True;False
...
Node;AmplifyShaderEditor.ColorNode;43;-1369.58,141.7365;Inherit;False;Property;_MainColor1;Main Color;0;0;Create;True;0;0;False;0;0.6698113,0.6698113,0.6698113,0;0.735849,0.735849,0.735849,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;45;-1360.083,-249.4618;Inherit;True;Property;_Glossiness1;Glossiness;8;0;Create;True;0;0;False;0;-1;ab611d0bba8a0334ca5fac9eaaf7419f;ab611d0bba8a0334ca5fac9eaaf7419f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=32244FECB455D9AF1F85AF800BB7E4EBFD549090