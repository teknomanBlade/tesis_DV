...
Shader "ToonShadowsGray"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( tex2D( _MainTexture1, uv_MainTexture1 ) * ( _TintColor * ( ( smoothstepResult34 * ase_lightColor ) + ( _SpecularColor1 * smoothstepResult37 * ase_lightAtten ) + ( _RimColor1 * ase_lightAtten * smoothstepResult36 ) + _AmbientColor1 ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
0;0;1536;803;1149.662;808.6091;1.750394;True;False
...
ASEEND*/
//CHKSM=DCFEEBA5CE9F99C5970893C021A5CC101CD26EF2