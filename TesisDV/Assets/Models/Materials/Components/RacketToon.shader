...
Shader "RacketToon"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = saturate( ( tex2D( _MainTexture, uv_MainTexture ) * ( _TintColor1 * ( ( smoothstepResult36 * ase_lightColor ) + ( _SpecularColor1 * smoothstepResult33 ) + ( _RimColor1 * float4( 0,0,0,0 ) * smoothstepResult37 ) + _AmbientColor1 ) ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
296;404;1307;378;1400.579;892.4041;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-2344.605,387.6036;Inherit;False;Property;_Glossiness1;Glossiness;4;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;-1000.605,259.6036;Inherit;False;Property;_AmbientColor1;Ambient Color;1;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;43;-856.6049,-428.3964;Inherit;False;Property;_TintColor1;TintColor;0;0;Create;True;0;0;False;0;0.735849,0.735849,0.735849,0;0.735849,0.735849,0.735849,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;46;-680.6049,-780.3964;Inherit;True;Property;_MainTexture;Main Texture;6;0;Create;True;0;0;False;0;-1;2ec3aff22090c1248aa82b65522cb127;a8cbc11ff2ace5645a729fff0beabc12;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=3BC3782718C751C685F07E362FFE148DB27823D5