...
Shader "RacketToon"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float smoothstepResult72 = smoothstep( temp_output_64_0 , temp_output_66_0 , ( temp_output_60_0 - _FirstPosition2 ));
			float smoothstepResult68 = smoothstep( temp_output_64_0 , temp_output_66_0 , ( temp_output_60_0 - _SecondPosition2 ));
			float temp_output_75_0 = ( saturate( smoothstepResult72 ) + saturate( ( smoothstepResult68 - _SecondPositionIntensity2 ) ) );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			c.rgb = saturate( ( tex2D( _MainTexture, uv_MainTexture ) * ( ( temp_output_75_0 + ( ( 1.0 - temp_output_75_0 ) * _ShadowIntensity2 ) ) * ase_lightColor * ase_lightAtten ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
307;472;1137;580;2045.234;794.3588;2.359575;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-2629.192,-25.14431;Inherit;False;Property;_SecondPosition2;SecondPosition;3;0;Create;True;0;0;False;0;0;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;-2997.192,-361.1443;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-3093.192,-25.14431;Inherit;False;Property;_Min2;Min;1;0;Create;True;0;0;False;0;0;0.38;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;62;-3093.192,102.8557;Inherit;False;Property;_Max2;Max;2;0;Create;True;0;0;False;0;0;0.56;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;67;-2421.192,-89.14426;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;66;-2821.192,102.8557;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-2933.192,-185.1443;Inherit;False;Property;_FirstPosition2;FirstPosition;0;0;Create;True;0;0;False;0;0;0.81;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMinOpNode;64;-2821.192,-25.14431;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;68;-2261.192,-73.14429;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-2245.192,182.8557;Inherit;False;Property;_SecondPositionIntensity2;SecondPositionIntensity;4;0;Create;True;0;0;False;0;0;0.81;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;70;-2773.192,-313.1443;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;72;-2277.192,-377.1443;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-1301.192,230.8557;Inherit;False;Property;_ShadowIntensity2;ShadowIntensity;6;0;Create;True;0;0;False;0;0;2.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;81;-629.1866,254.5345;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;46;-680.6049,-780.3964;Inherit;True;Property;_MainTexture;Main Texture;5;0;Create;True;0;0;False;0;-1;2ec3aff22090c1248aa82b65522cb127;a8cbc11ff2ace5645a729fff0beabc12;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0C0AA1EC4F27068B5A8CE903028062D99F01E2E1