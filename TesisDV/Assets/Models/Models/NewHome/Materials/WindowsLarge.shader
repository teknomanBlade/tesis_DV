...
Shader "WindowsLarge"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			c.rgb = saturate( ( tex2DNode45 * ( ( temp_output_72_0 + ( ( 1.0 - temp_output_72_0 ) * _ShadowIntensity3 ) ) * ase_lightColor ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17800
425;417;1137;547;1649.787;1683.609;3.313538;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-111.1399,-68.61603;Inherit;False;Property;_ShadowIntensity3;Shadow Intensity;6;0;Create;True;0;0;False;0;0;1.83;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D9001D8792B24EE86AEB2FA5D63E1FC629D44064