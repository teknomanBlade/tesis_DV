...
Shader "ToonShadowsDecalsWithTransparency"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			float4 temp_output_50_0 = saturate( ( ( tex2DNode45 * _Color_Decals ) * ( ( temp_output_74_0 + ( ( 1.0 - temp_output_74_0 ) * _ShadowIntensity ) ) * ase_lightColor ) ) );
...
/*ASEBEGIN
Version=17800
385;444;1195;476;2397.112;2359.879;5.659795;True;False
...
Node;AmplifyShaderEditor.ColorNode;251;1782.183,-1096.808;Inherit;False;Property;_ColorTint;ColorTint;11;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6E83A9E6108F81493077B8C80798ECC07ECADF60