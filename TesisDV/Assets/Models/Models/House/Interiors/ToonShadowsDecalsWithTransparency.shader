...
Shader "ToonShadowsDecalsWithTransparency"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			c.rgb = saturate( ( tex2DNode45 * ( ( temp_output_74_0 + ( ( 1.0 - temp_output_74_0 ) * _ShadowIntensity ) ) * ase_lightColor ) ) ).rgb;
			c.a = tex2DNode45.a;
			return c;
		}
...
/*ASEBEGIN
Version=17800
7;89;1906;930;548.7483;1106.076;1.698743;True;False
...
ASEEND*/
//CHKSM=1829AA11287EAEA57EAD99E2BB5B7C5F0A6648FF